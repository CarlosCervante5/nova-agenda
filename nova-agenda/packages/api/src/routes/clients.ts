  ...
  try {
    ...
    const client = await prisma.client.update({
      ...
      data: {
        ...
        ...(bodyTextColor !== undefined && { bodyTextColor }),
        ...(labelTextColor !== undefined && { labelTextColor }),
        ...(surfaceBgColor !== undefined && { surfaceBgColor }),
        ...(logo !== undefined && { logo }),
        ...
        ...(linktreeUrl !== undefined && { linktreeUrl: linktreeUrl || null }),
        ...(Array.isArray(customLinks) && { customLinks: JSON.stringify(customLinks) }),
