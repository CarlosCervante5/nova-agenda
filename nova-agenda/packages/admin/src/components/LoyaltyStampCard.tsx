...
export const ESTUDIO_CARD_DESIGN: CardDesign = {
  style: 'estudio',
  title: 'TARJETA',
  script: 'de fidelidad',
  footerTitle: 'Gracias por tu visita',
  footerSubtitle: 'Acumula compras y obtén recompensas',
  stampShape: 'heart',
  columns: 10,
  milestoneColor: '#1a1a1a',
};
...
export default function LoyaltyStampCard({
  ...
  return (
    ...
    >
      <div className={`flex items-start ${estudio ? 'justify-between' : 'justify-between'} gap-3 ${compact ? 'mb-3' : 'mb-5'}`}>
      ...
      >
        {Array.from({ length: total }).map((_, i) => {
          ...
          const fill = reward
            ? (design.milestoneColor || textColor)
            : stampColor;
          return (
